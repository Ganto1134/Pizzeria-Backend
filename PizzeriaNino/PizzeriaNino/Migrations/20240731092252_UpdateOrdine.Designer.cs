...
namespace PizzeriaNino.Migrations
{
    ...
    [Migration("20240731092252_UpdateOrdine")]
    partial class UpdateOrdine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzeriaNino.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzeriaNino.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzeriaNino.Models.OrderItem", b =>
                {
                    b.HasOne("PizzeriaNino.Models.Order", "Order")
                        .WithMany("OrderItems")
